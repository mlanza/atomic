...
QUnit.test("ilookup", function(assert){
  ...
  var getAddressLine1 = _.opt(_.get(v, "address"), _.get(v, "lines"), _.get(v, 1));
  assert.equal(moe |> getAddressLine1, null);
  assert.equal(_.maybe(boris, _.get(v, "address"), _.get(v, "lines"), _.get(v, 1)), "Suite 401");
