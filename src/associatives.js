...
import {isAssociative, isSequential, isDescriptive, ILookup, IArray, IObject, ISeq, IAssociative, IReduce, IKVReduce, IEmptyableCollection, IEquiv, ICollection, ISeqable} from "./protocols";
...
export function assocIn(self, keys, value){
  ...
  switch (keys.length) {
    ...
    default:
      return IAssociative.assoc(self, key, assocIn(get(self, key), IArray.toArray(ISeq.rest(keys)), value));
  }
}
