import {overload, curry, partial, partly, flip, subj, constantly, identity, NIL, TRUE, FALSE, ZERO, ONE} from './core';
...
export const into         = partly(c.into);
export const transduce    = partly(c.transduce);
...
export const tag          = partly(el.tag);
