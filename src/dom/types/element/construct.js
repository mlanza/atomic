...
export const element = curry(passDocumentDefault(function element(document, name, ...contents){
  const el = document.createElement(name);
  apply(embeds, el, flatten(contents));
  return el;
}), 2);

export const elementns = curry(passDocumentDefault(function elementns(document, ns, name, ...contents){
