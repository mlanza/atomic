...
export const into         = prep(overload(constantly([]), identity, c.into, c.intoX));
...
export const min          = subj(_.unspread(c.min), 2);
export const max          = subj(_.unspread(c.max), 2);
...
export const startsWith   = subj(string.startsWith);
export const endsWith     = subj(string.endsWith);
