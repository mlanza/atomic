import {overload, identity, obj, partly, doto, branch, unspread, applying} from "./core";
...
import {satisfies, filter, spread, specify, maybe, each, see, props, classes, isEmpty, duration, compact, remove, flatten, map, fragment, element, sort, flip, realized, comp, isNumber, mapSomeVals, isFunction, apply} from "./types";
...
import {toggles} from "./types/element/behave";
