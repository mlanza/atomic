...
export {log, juxt, isTrue, isFalse, see, rand, overload, constantly, comp, pipe, chain, maybe, opt, partial, isOdd, isEven, memoize, doto, supply, fst, snd, spread, unspread, nullary, unary, binary, inc, dec} from './core';
