...
export {constantly, comp, pipe, chain, maybe, opt, partial, isOdd, isEven, tap, firstly as coalesce} from './core';
export {extend, satisfies} from './protocol';
export {expanding, update, updateIn, assocIn, getIn, cat, concat, selectKeys, some, someFn, everyPred, isEvery, isAny, isNotAny, iterate, cycle, each, range, butlast, expansive, groupBy, scan, best} from './coll';
...
export const inc          = partial(_.add, +1);
export const dec          = partial(_.add, -1);
export const memoize      = overload(null, _.memoize, _.memoizeWith);
export const firstly      = overload(NIL, _.firstly);
export const lastly       = overload(NIL, _.lastly);
export const or           = overload(NIL, identity, _.firstly);
export const and          = overload(TRUE, identity, _.lastly);
...
export const into         = overload(constantly([]), identity, c.into, c.intoX);
