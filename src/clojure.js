...
export {expanding, update, updateIn, assocIn, getIn, cat, concat, selectKeys, some, someFn, everyPred, isEvery, isAny, isNotAny, iterate, cycle, each, range, butlast, expansive, groupBy, scan, best, into, transduce} from './coll';
